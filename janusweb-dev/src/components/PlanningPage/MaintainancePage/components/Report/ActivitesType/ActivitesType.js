...
const ActivitesType = ({
  ...
  const handleFindClick = async () => {
    ...
    setMaintainancePlan(allMaintenancePlan);
  ...
  const getAllMaintenancePlan = async (spinner) => {
    ...
    try {
      ...
      //   }
      // });
      const buildData = groupMaintenancePlansByBuilding(
        allMaintenancePlan?.data
      );
      setPlanningGroupsByType(buildData);
      if (switchState) {
        ...
        let updatedPrintData = addVAT(updatedData, percent);
  ...
  console.log("cost maintainancePlan", maintainancePlan);
  return (
    <>
      {/* Filter Code */}
      <Filter
              ...
              {maintainancePlan?.map((elem) => (
                <>
                  <tr className="activites_start_year activites_year_cost_main">
                    ...
                    <td></td>
                    <td>
                      {formatCost(elem?.total_cost || elem?.totalCost)}
                      {/* {elem?.totalCost} */}
                    </td>
                    <td></td>
                  </tr>
